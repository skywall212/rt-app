{{-- resources/views/admin/laporan/pulasara.blade.php --}}
@extends('layouts.app')
...
<div class="container-fluid">
    <form method="GET" action="{{ route('admin.laporan.pulasara') }}" class="row g-2 mb-3">
        <div class="col-auto">
        ...
        <div class="col-auto">
            <a href="{{ route('admin.laporan.pulasara_pdf', ['tahun' => $tahun]) }}" class="btn btn-danger btn-sm" target="_blank">⬇️ Export PDF</a>
        </div>
    </form>

    <h4 class="text-center laporan-title mb-2">📑 PEMASUKAN PULASARA WARGA RT.04</h4>
        ...
        <div class="card-body p-2">
                    ...
                    <tbody>
                        @forelse($laporan as $item)
                            <tr>
                                ...
                                <td><span class="badge bg-primary">{{ $item['jumlah_bulan'] }}</span></td>
            ...
            <div class="summary">
                <table style="width:auto;">
                    ...
                    <tr>
                        <td style="font-weight:bold;">Total Pembayaran Pulasara</td>
